...
export default function ChecklistFormPage() {
  ...
  const updateField = <K extends keyof ChecklistFormData>(
    field: K,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (dropboxConfigured && dropboxToken) {
        ...
        const result = await uploadChecklistPdf(
          formData.roomNumber,
          pdfBytes,
          dropboxToken,
        );
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="roomOdor" className="font-medium">
                      Room Odor – Note smell upon entry (musty, chemical,
                      sewage, neutral)
                    </Label>
                  </div>
                  <Input
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updateField("section1", {
                          ...formData.section1,
                          thermostatCheck: {
                            ...formData.section1.thermostatCheck,
                            checked: !!checked,
                          },
                        })
                      }
                    ...
                    <Label htmlFor="thermostatCheck" className="font-medium">
                      Thermostat Check – Verify thermostat is functional and
                      displayed room temperature matches actual room temp
                    </Label>
                  </div>
            ...
            <ChecklistSection
              title="3. Kitchen/Bathroom Inspection (8-9 Minutes)"
              ...
              <div className="space-y-4">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updateField("section3", {
                          ...formData.section3,
                          hotWaterFixtures: {
                            ...formData.section3.hotWaterFixtures,
                            checked: !!checked,
                          },
                        })
                      }
                ...
                <div className="space-y-2">
                  <Label htmlFor="hotWaterArrivalTime" className="font-medium">
                    When turning the water on, how long does it take for the hot
                    water to arrive?
                  </Label>
                  <Input
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      updateField("section3", {
                        ...formData.section3,
                        soapDispenser: !!checked,
                      })
                    }
                  />
                  <Label htmlFor="soapDispenser" className="font-medium">
                    Soap dispenser tested - If applicable
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="disposalCheck"
                    checked={formData.section3.disposalCheck}
                    onCheckedChange={(checked) =>
                      updateField("section3", {
                        ...formData.section3,
                        disposalCheck: !!checked,
                      })
                    }
                  />
                  <Label htmlFor="disposalCheck" className="font-medium">
                    Check Disposal for proper function/cracks in the
                    housing/leaks
                  </Label>
                </div>
                    ...
                    <YesNoField
                      ...
                      onChange={(value) =>
                        updateField("section3", {
                          ...formData.section3,
                          toiletFlushTest: {
                            ...formData.section3.toiletFlushTest,
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      updateField("section3", {
                        ...formData.section3,
                        rearCaulkOpening: !!checked,
                      })
                    }
                  />
                  <Label htmlFor="rearCaulkOpening" className="font-medium">
                    1&quot; rear caulk opening verified
                  </Label>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      updateField("section4", {
                        ...formData.section4,
                        underSinksDry: !!checked,
                      })
                    }
                  />
                  <Label htmlFor="underSinksDry" className="font-medium">
                    Under sinks dry (check for water marks, leaks from shut off
                    valves or faucet connections)
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      updateField("section4", {
                        ...formData.section4,
                        behindRefrigeratorDry: !!checked,
                      })
                    }
                  />
                  <Label
                    htmlFor="behindRefrigeratorDry"
                    className="font-medium"
                  >
                    Behind refrigerator dry and free of mold - If Applicable
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      updateField("section4", {
                        ...formData.section4,
                        waterHeaterAreaDry: !!checked,
                      })
                    }
                  />
                  <Label htmlFor="waterHeaterAreaDry" className="font-medium">
                    Water heater area dry - If applicable
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      updateField("section4", {
                        ...formData.section4,
                        mainShutOffValveExercised: !!checked,
                      })
                    }
                  />
                  <Label
                    htmlFor="mainShutOffValveExercised"
                    className="font-medium"
                  >
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      updateField("section5", {
                        ...formData.section5,
                        allFixturesOff: !!checked,
                      })
                    }
                  />
              ...
              {uploadStatus === "success" && (
                <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                  ...
                  <span className="text-sm font-medium">
                    PDF uploaded to Dropbox successfully
                  </span>
                </div>
              )}
              {uploadStatus === "error" && (
                <div className="flex items-center gap-2 text-destructive">
                  ...
                  <span className="text-sm font-medium">
                    Dropbox upload failed – PDF was downloaded locally
                  </span>
                </div>
              )}
              <Button
